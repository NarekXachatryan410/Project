...
export default function SignupPage() {
  ...
  const handleSubmit = (e: FormEvent) => {
    e.preventDefault();
    Axios.post<IUser>("/signup", { name, surname, login, email, password })
      .then(() => {
        setError("");
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-emerald-100 to-green-200 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <h2 className="text-3xl font-extrabold text-gray-800 mt-4">Create Your Account ✨</h2>
          <p className="text-gray-600 mt-1 text-sm">Join the chat world — it’s free and fun!</p>
        </motion.div>
